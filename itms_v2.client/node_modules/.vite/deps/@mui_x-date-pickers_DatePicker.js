import {
  ...
  useViews,
  validateDate
} from "./chunk-AVFWUHHP.js";
import {
  LocalizationProvider
} from "./chunk-5CUQ6CYF.js";
import "./chunk-RW3DMCEO.js";
import "./chunk-OVF4UKO7.js";
import {
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    ...
    renderLoading: (_themeProps$renderLoa = themeProps.renderLoading) != null ? _themeProps$renderLoa : () => (0, import_jsx_runtime11.jsx)("span", {
      children: "..."
    }),
    minDate: applyDefaultDate(utils, themeProps.minDate, defaultDates.minDate),
    maxDate: applyDefaultDate(utils, themeProps.maxDate, defaultDates.maxDate)
...
var DateCalendar = React10.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsxs)(DateCalendarRoot, _extends({
    ...
    children: [(0, import_jsx_runtime11.jsx)(CalendarHeader, _extends({}, calendarHeaderProps)), (0, import_jsx_runtime11.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
...
var useMobilePicker = (_ref) => {
  ...
  const utils = useUtils();
  const internalInputRef = React13.useRef(null);
  const labelId = useId();
  const isToolbarHidden = (_innerSlotProps$toolb = innerSlotProps == null || (_innerSlotProps$toolb2 = innerSlotProps.toolbar) == null ? void 0 : _innerSlotProps$toolb2.hidden) != null ? _innerSlotProps$toolb : false;
  const {
    open,
  ...
  const renderPicker = () => (0, import_jsx_runtime15.jsxs)(LocalizationProvider, {
    ...
    children: [(0, import_jsx_runtime14.jsx)(Field, _extends({}, fieldProps, {
      ...
      slotProps,
      inputRef: handleInputRef
    })), (0, import_jsx_runtime14.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
...
// node_modules/@mui/x-date-pickers/MobileDatePicker/MobileDatePicker.js
var MobileDatePicker = React14.forwardRef(function MobileDatePicker2(inProps, ref) {
...
var DatePicker = React15.forwardRef(function DatePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDatePicker"
  });
